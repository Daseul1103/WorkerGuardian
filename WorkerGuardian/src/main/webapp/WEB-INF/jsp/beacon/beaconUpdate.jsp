...
<head>
	...
	<link rel="stylesheet" href="/css/beacon/beaconUpdate.css"/>
    ...
    <script>
        $(document).ready(function() {	
        	...
        	var nowId = "${data.UUID}";
			var nowSiteId = "${data.SITE_ID}";
			var LimitFlag = "${data.LIMIT_FLAG}";
    ...
    <div class="main_div">  <!-- 메인 div -->
        ...
        <div class="bread_div">
            <div class="breadcrumb">
                ...
                <div class="next"></div>
                <div class="menu2" style="color: white; font-size: 16px;">비콘 정보 수정</div>
            </div>
        </div>
            ...
            <div class="site_info">
                <div class="main_title_div">
                    <div class="site_title">
                        <p id="site_title" style="font-size: 35px; font-weight: bold; margin: 0;">${data.BEACON_NAME} 정보 수정</p>
                    </div>
                    <div class="breadcrumb">
                ...
                <div class="main_content_div">
                    ...
                    <div class="table_div">
                    <form id="updateFrm" name="updateFrm" method="post" action="/beacon/beaconUpdateSave.do">
                        <table class="table">
                            <colgroup>
                                <col style="width: 18%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" id="BEACON_NAME" name="BEACON_NAME" value="${data.BEACON_NAME}"/></td>
                                    <th scope="row">UUID</th>
                                    <td><input type="text" id="UUID" name="UUID" value="${data.UUID}" readonly/></td>
                                </tr>
                                <tr>
                                    <th scope="row">Major</th>
                                    <td><input type="text" id="MAJOR" name="MAJOR" value="${data.MAJOR}"/></td>
                                    <th scope="row">Minor</th>
                                    <td><input type="text" id="MINOR" name="MINOR" value="${data.MINOR}"/></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="mini_title">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" style="display: flex; align-items: center; border-bottom: none;">
									    ...
									    <label for="Yes" style="margin-left: 10px; margin-right: 20px;">예</label>
									
									    <input type="radio" name="LIMIT_FLAG" value="N" id="No" class="limit_flag" style="margin: 0;"
									        <c:if test="${data.LIMIT_FLAG == 'N'}">checked</c:if> />
									    <label for="No" style="margin-left: 10px; margin-right: 20px;">아니오</label>
									</td>
                                </tr>
                                <tr>
