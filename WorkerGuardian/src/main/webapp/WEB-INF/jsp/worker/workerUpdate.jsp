...
<head>
	...
	<link rel="stylesheet" href="/css/worker/workerUpdate.css"/>
        	...
        	$.ajax({
                ...
                success: function(data) {
                    ...
                    siteList.forEach(function(site) {
                        var selected = (site.site_ID === nowSiteId) ? ' selected' : '';
                        html += '<option value="' + site.site_ID + '"' + selected + '>' + site.site_NAME + '</option>\n';
                    });
    ...
    <div class="main_div">  <!-- 메인 div -->
        ...
        <div class="bread_div">
            <div class="breadcrumb">
                ...
                <div class="next"></div>
                <div class="menu2" style="color: white; font-size: 16px;">작업자 정보 수정</div>
            </div>
        </div>
            ...
            <div class="site_info">
                <div class="main_title_div">
                    <div class="site_title">
                        <p id="site_title" style="font-size: 35px; font-weight: bold; margin: 0;">${data.WORKER_NAME} 정보 수정</p>
                    </div>
                    <div class="breadcrumb">
                ...
                <div class="main_content_div">
                    ...
                    <div class="table_div">
                    <form id="updateFrm" name="updateFrm" method="post" action="/worker/workerUpdateSave.do">
                        <table class="table" style="margin-bottom:20px;">
                            ...
                            <tbody>
                                <tr>
                                	<input type="hidden" name="WORKER_ID" id="WORKER_ID" value="${data.WORKER_ID}"></input>
                                    <th scope="row">작업자 이름</th>
                                    <td><input type="text" name="WORKER_NAME" id="WORKER_NAME" value="${data.WORKER_NAME}"></input></td>
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; align-items: center;">
									    <input type="radio" id="WORKER_GENDER_M" name="WORKER_GENDER" value="M" style="margin:0;"
									        <c:if test="${data.WORKER_GENDER == 'M'}">checked</c:if>>
									    <label for="WORKER_GENDER_M">
									        <p style="margin:0; margin-left:10px; margin-right:20px;">남성</p>
									    </label>
									
									    <input type="radio" id="WORKER_GENDER_F" name="WORKER_GENDER" value="F" style="margin:0;"
									        <c:if test="${data.WORKER_GENDER == 'F'}">checked</c:if>>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id="WORKER_BIRTHDAY" name="WORKER_BIRTHDAY" value="${data.WORKER_BIRTHDAY}"></input></td>
                                    <th scope="row">전화번호</th>
                                    <td><input type="text" id="WORKER_PHONE" name="WORKER_PHONE" value="${data.WORKER_PHONE}" readonly></input></td>
                                </tr>
                                <tr>
                                    <th scope="row">작업자 정보</th>
                                    <td colspan="3" ><input type="text" id="WORKER_INFO" name="WORKER_INFO" value="${data.WORKER_INFO}"></input></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="mini_title">
                        ...
                        <table class="table" style="margin-bottom:10px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                    	&nbsp;주의 : <input type="text" name="DANGER_DETECT_C" id="DANGER_DETECT_C" style="width:90px;" value="${data.DANGER_DETECT_C}"></input> m &nbsp;
                                    	&nbsp;경고 : <input type="text" name="DANGER_DETECT_W" id="DANGER_DETECT_W" style="width:90px;" value="${data.DANGER_DETECT_W}"></input> m &nbsp;
                                    	&nbsp;위험 : <input type="text" name="DANGER_DETECT_D" id="DANGER_DETECT_D" style="width:90px;" value="${data.DANGER_DETECT_D}"></input> m 
                                    </td>
                                </tr>
                                <tr>
                                    <th scope="row">유해 가스 감지 기준</th>
                                    <td colspan="3"><input type="text" id="GAS_DETECT" name="GAS_DETECT" style="width:90px;" value="${data.GAS_DETECT}"></input> ppm</td>
                                </tr>
                            </tbody>
                        </table>
                     </form>   
