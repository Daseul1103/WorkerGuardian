...
<head>
	...
	<link rel="stylesheet" href="/css/gas/gasInsert.css"/>
        	...
        	$.ajax({
			    ...
			    success: function(data) {
			        ...
			        workerList.forEach(function(worker) {
			            html += '<option value="' + worker.GAS_WORKER_ID + '">' + worker.WORKER_NAME + '</option>\n';
			        });
    ...
    <div class="main_div">  <!-- 메인 div -->
        ...
        <div class="bread_div">
            <div class="breadcrumb">
                ...
                <div class="next"></div>
                <div class="menu2" style="color: white; font-size: 16px;">가스 센서 등록</div>
            </div>
        </div>
            ...
            <div class="site_info">
                <div class="main_title_div">
                    <div class="site_title">
                        <p id="site_title" style="font-size: 35px; font-weight: bold; margin: 0;">가스 센서 신규 등록</p>
                    </div>
                    <div class="breadcrumb">
                ...
                <div class="main_content_div">
                    ...
                    <div class="table_div">
                    <form id="frmGas" name="frmGas" method="post" action="/gas/gasSave.do">
                        <table class="table">
                            <colgroup>
                                <col style="width: 18%;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" id="GAS_ID" name="GAS_ID"></input></td>
                                    <th scope="row">가스 센서 이름</th>
                                    <td><input type="text" id="GAS_NAME" name="GAS_NAME"></td>
                                </tr>
                                <tr>
                                    <th scope="row">가스 센서 업체</th>
                                    <td><input type="text" id="GAS_COMPANY" name="GAS_COMPANY"></td>
                                    <th scope="row">가스 센서 종류</th>
                                    <td><input type="text" id="GAS_TYPE" name="GAS_TYPE"></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><input type="text" id="DANGER_PER" name="DANGER_PER"> ppm</td>
                                </tr>
                            </tbody>
                        </table>
                     </form>   
