            ...
            <div class="site_info">
                <div class="main_title_div">
                    <div class="site_title">
                        <p id="site_title" style="font-size: 35px; font-weight: bold; margin: 0;">선택 된 현장 없음</p>
                    </div>
                    <div class="breadcrumb">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="3" id="site_name"></td>
                                </tr>
                                <tr>
                                    <th scope="row">현장 파일</th>
                                    <td colspan="3"><p class="site_file"></p></td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="mini_title">
